...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUseCase(clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createClearUseCase(ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessObject) {
